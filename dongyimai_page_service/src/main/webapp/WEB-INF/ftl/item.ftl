					...
					<div class="clearfix choose">
						<div id="specification" class="summary-wrap clearfix">
							...
							<dl>
								...
								<#list spec.attributeValue as at>
								<dd><a href="javascript:;" ng-click="selectSpecification('${spec.attributeName}','${at}')" class="{{isSelected('${spec.attributeName}','${at}')?'selected':'' }} ">${at}<span title="点击取消选择">&nbsp;</span>
                             </a></dd>
								</#list>
						...
						<div class="tab-content tab-wraped">
							<div id="one" class="tab-pane active">
								<ul class="goods-intro unstyled">
									<#if customAttributeItems??>
										<#list customAttributeItems as cs>
											<li>${cs.text}:${cs.value}</li>
										</#list>
